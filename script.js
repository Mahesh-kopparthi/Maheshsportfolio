...
$(document).ready(function () {
    ...
    var typed = new Typed(".typing",{
        strings: ["web developer","python developer","Frontend Developer","software developer"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true,
        fadeOut: true,
    ...
    var typed = new Typed(".typing-2",{
        strings: ["Programmer","Python Developer","Data structures and algorithims learner","Software developer"],
        typeSpeed: 66,
        backSpeed: 66,
        loop: true,
    });
